...
(
    ...
    constraint UK_fifm9mphh9mhek08orcd96jg7
        unique (location_id)
)
    engine = MyISAM;
...
INSERT INTO YanDatabase.UMS_UNIVERSITY (id, isEYY, isJBW, isYJSY, isZHX, name, officialUrl, `rank`, city_id, location_id) VALUES (1, 1, 1, 1, 1, '电子科技大学', 'www.dzkjdx.com', 8, 2, 1);
